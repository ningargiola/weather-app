...
import { kelvinToFarhenheit, unixToDate, unixToTime } from '@/app/utils/misc';
...
function FiveDayForecast() {
    ...
    const processData = (
        ...
        return {
            ...
            minTemp: kelvinToFarhenheit(minTemp),
            maxTemp: kelvinToFarhenheit(maxTemp),
        };
    };
                ...
                return (
                    ...
                    >
                        ...
                        <div className='flex-1 flex items-center justify-between gap-4'>
                            <p className='font-bold'>{day.minTemp.toFixed(0)}°F</p>
                            <div className="temperature flex-1 w-full h-2 rounded-lg"></div>
                            <p className='font-bold'>{day.maxTemp.toFixed(0)}°F</p>
                        </div>
                    </div>
                );
            })}
